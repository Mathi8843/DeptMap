    ...
    >
      ...
      <main className="max-w-7xl mx-auto px-6">
        ...
        <section className="pt-20 pb-16 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                href="/onboarding"
                className="flex items-center gap-2 font-mono text-[11px] uppercase tracking-[1.5px] font-bold px-6 py-3.5 bg-[#b8ff57] text-black rounded-xl hover:bg-[#d4ff8a] transition-all shadow-lg shadow-[#b8ff57]/10"
              >
          ...
          <div className="bg-[#0d0d1a] border border-white/8 rounded-2xl p-8 space-y-6 shadow-2xl">
            <div>
              ...
              <Link
                href="/onboarding"
                className="w-full flex items-center justify-center gap-2.5 py-3.5 border border-white/10 rounded-xl text-sm font-semibold text-white hover:bg-white/5 transition-all mb-5"
              >
        ...
        <section className="py-16 border-t border-white/5 text-center">
          ...
          <Link
            href="/onboarding"
            className="inline-flex items-center gap-2 font-mono text-[11px] uppercase tracking-[1.5px] font-bold px-8 py-4 bg-[#b8ff57] text-black rounded-xl hover:bg-[#d4ff8a] transition-all shadow-lg shadow-[#b8ff57]/10"
          >
