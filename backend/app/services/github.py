...
def create_fix_pull_request(
    ...
    commit_message = f"security-fix: {issue_title}\n\nAuto-generated fix by DebtMap. Issue ID: {issue_id}"
    repo.update_file(
        path=file_path,
    ...
    body_parts = [
        "## 🔒 Security Fix — Auto-generated by DebtMap\n",
        f"**Issue:** {issue_title}\n",
        f"**File:** `{file_path}`\n",
        "This pull request was automatically created by DebtMap. The AI-generated fix has been applied to resolve the detected vulnerability.\n",
    ]
